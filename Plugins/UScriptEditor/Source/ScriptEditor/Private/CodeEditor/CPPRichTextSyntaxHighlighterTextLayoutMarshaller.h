...
public:
	...
	{
		FSyntaxTextStyle()
			: NormalTextStyle(FScriptEditorStyle::Get().GetWidgetStyle<FTextBlockStyle>("SyntaxHighlight.CPP.Normal"))
			, OperatorTextStyle(FScriptEditorStyle::Get().GetWidgetStyle<FTextBlockStyle>("SyntaxHighlight.CPP.Operator"))
			, KeywordTextStyle(FScriptEditorStyle::Get().GetWidgetStyle<FTextBlockStyle>("SyntaxHighlight.CPP.Keyword"))
			, StringTextStyle(FScriptEditorStyle::Get().GetWidgetStyle<FTextBlockStyle>("SyntaxHighlight.CPP.String"))
			, NumberTextStyle(FScriptEditorStyle::Get().GetWidgetStyle<FTextBlockStyle>("SyntaxHighlight.CPP.Number"))
			, CommentTextStyle(FScriptEditorStyle::Get().GetWidgetStyle<FTextBlockStyle>("SyntaxHighlight.CPP.Comment"))
			, PreProcessorKeywordTextStyle(FScriptEditorStyle::Get().GetWidgetStyle<FTextBlockStyle>("SyntaxHighlight.CPP.PreProcessorKeyword"))
		{
		}
