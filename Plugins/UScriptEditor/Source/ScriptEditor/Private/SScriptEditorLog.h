...
class FScriptEditorLogTextLayoutMarshaller;
class SSearchBox;
 ...
 */
class SScriptEditorConsoleInputBox
	: public SCompoundWidget
{

public:

	SLATE_BEGIN_ARGS(SScriptEditorConsoleInputBox) {}
...
protected:
	...
	TSharedPtr< FScriptEditorLogTextLayoutMarshaller > MessagesTextMarshaller;
...
class FScriptEditorLogTextLayoutMarshaller : public FBaseTextLayoutMarshaller
{
public:

	static TSharedRef< FScriptEditorLogTextLayoutMarshaller > Create(TArray< TSharedPtr<FLogMessage> > InMessages);

	virtual ~FScriptEditorLogTextLayoutMarshaller();
...
protected:
	...
	FScriptEditorLogTextLayoutMarshaller(TArray< TSharedPtr<FLogMessage> > InMessages);
...
class FScriptLogHistory : public FOutputDevice
{
public:
...
protected:
	...
	virtual void Serialize(const TCHAR* V, ELogVerbosity::Type Verbosity, const class FName& Category) override
	{
		...
		SScriptEditorLog::CreateLogMessages(V, Verbosity, Category, Messages);
	}
