...
void UScriptHookClient::RegisterLuaState(lua_State* State)
{
	...
	UE_LOG(LogTemp, Log, TEXT("Remote HostSocket try to Connect ip[%s] port[%d]"), *HookIP, HookPort);
...
bool UScriptHookClient::PropertyTranslate(FString& VarValue, FString& VarType, int32& KindType, void*& VarPtr, FProperty* Property, UObject* Object)
{
	//reset data
	VarValue.Empty();
