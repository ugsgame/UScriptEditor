...
local BP_DefaultWeapon_C = Class("Scripts.Weapon.BP_WeaponBase_C")
...
function BP_DefaultWeapon_C:SpawnProjectile()
	if self.ProjectileClass then
		...
		local Projectile = self.World:SpawnActor(self.ProjectileClass, Transform, UE4.ESpawnActorCollisionHandlingMethod.AlwaysSpawn, self, self.Instigator, "Scripts.Weapon.BP_DefaultProjectile_C", BaseColor)
	end
end
